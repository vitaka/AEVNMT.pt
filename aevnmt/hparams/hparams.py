...
options = {
    ...
    "transformer_inference_network":(bool, False, False, "Inference network is a transformer instead of a BiLSTM", 1),
    ...
    "bow_loss_product_bernoulli_norm_uniform":(bool, False, False, "Normalize weight of Bernoulli BoW/MADE loss assuming uniform distribution", 1),
    "disable_bow_loss_norm":(bool, False, False, "Do not normalize Bernoulli BoW/MADE loss (with a default normalization weight based on number of predictions)", 1),
    "MADE_loss":(bool, False, False, "Add MADE Bernoulli to the loss", 1),
