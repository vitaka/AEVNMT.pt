...
class RNNLM(nn.Module):
    ...
    def __init__(self, vocab_size, emb_size, hidden_size, pad_idx,
                 dropout, num_layers, cell_type, tied_embeddings, add_input_size,embedder=None, gate_z=False):
        """
        ...
        if gate_z:
            self.gate_linear=nn.Linear(emb_size+add_input_size+hidden_size,add_input_size)
